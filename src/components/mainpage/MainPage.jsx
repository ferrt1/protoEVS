      ...
      <div className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed  bg-[hsla(0,0%,0%,0.5)] flex">
        <div className="container m-auto flex justify-center items-center p-2 md:p-0">
          <div className="border border-secondary p-6 grid grid-cols-1 gap-3  bg-white shadow-lg rounded-lg">
            ...
            <h1 className="text-[18px] font-bold text-secondary">Reserva tus pasajes:</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-2 md:gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 border border-secondary p-2 rounded w-100">
                <div>
                  <p className="font-bold md:hidden text-secondary">Fecha Salida:</p>
                  <p className="hidden md:font-bold md:block text-secondary">Seleccione su fecha de salida:</p>
                  <LocalizationProvider dateAdapter={AdapterDayjs} label="Salida">
                  <DatePicker format="DD/MM/YYYY"/>
                  </LocalizationProvider>
                </div>
              <div>
                <p className="font-bold md:hidden text-secondary">Fecha Llegada:</p>
                <p className="hidden md:font-bold md:block  text-secondary">Seleccione su fecha de llegada:</p>
                <LocalizationProvider dateAdapter={AdapterDayjs} label="Destino">
                  <DatePicker format="DD/MM/YYYY"/>
                </LocalizationProvider>
              </div>
